...
const BoltDivider = () => (
  <div style={{ display:"flex", alignItems:"center", gap:12, margin:"0 0 48px" }}>
    ...
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#334155" strokeWidth="1.5"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
  ...
  if (submitted) return (
    <div style={styles.successBox}>
      ...
      <p style={styles.successText}>
        We'll review your info and reach out within <span style={{ color:"#F97316", fontWeight:700 }}>48 hours</span> to schedule your vetting call. Welcome to MechConnect.
      </p>
    </div>
  );
